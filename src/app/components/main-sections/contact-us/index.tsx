...
export default function ContactUs() {
  return (
    <section className="h-screen" id="contact-us">
      ...
      <div className="flex md:flex-row justify-evenly items-center w-full h-full flex-col sm:py-8">
        <div className="flex flex-col sm:w-1/2 md:border-r-2 border-[#bcbcbca9] justify-center items-center sm:h-3/4">
          <div className="flex flex-col gap-8 max-w-[340px] justify-evenly">
            <h1 className="text-2xl sm:text-7xl font-bold text-center xl:text-start">Tell us your new challenge</h1>
