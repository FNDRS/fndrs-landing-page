...
export default function ContactUs() {
  return (
    <section className="h-screen flex justify-center" id="contact-us">
      ...
      <div className="flex md:flex-row justify-evenly sm:justify-between items-center w-full h-full flex-col sm:py-8 md:w-[900px]">
        <div className="flex flex-col sm:w-1/2 md:border-r-2 border-[#bcbcbca9] justify-center items-center sm:h-3/4 sm:items-start">
          <div className="flex flex-col gap-8 max-w-[440px] justify-evenly">
