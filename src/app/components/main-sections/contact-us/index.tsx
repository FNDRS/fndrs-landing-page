...
export default function ContactUs() {
  return (
    <section className="h-screen w-screen">
      ...
      <div className="flex flex-col w-full h-screen xl:flex-row xl:justify-around xl:items-center justify-evenly">
        ...
        <div className="w-full h-full xl:w-6/12 flex items-center justify-center px-12">
